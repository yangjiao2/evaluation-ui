...
function Tooltip({
  ...
  const colorClasses = (bg) => {
    switch (bg) {
      ...
      case 'dark':
        return 'bg-slate-400 text-slate-100 border-slate-600';
      default:
        return 'text-slate-200 bg-white dark:bg-slate-400 dark:text-slate-100 border-slate-200 dark:border-slate-600';
    }
  };    
