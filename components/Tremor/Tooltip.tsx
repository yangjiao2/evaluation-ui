        ...
        >
          ...
          <TooltipPrimitives.Portal>
            <TooltipPrimitives.Content
              ...
              className={cx(
                // base
                "max-w-120 select-none rounded-md px-2.5 py-1.5 text-sm leading-5 shadow-md",
                // text color
                "text-gray-900 dark:text-gray-900",
                // background color
                "bg-lime-200 dark:bg-gray-50",
                // transition
            ...
            >
              ...
              {showArrow ? (
                <TooltipPrimitives.Arrow
                  className="border-none fill-lime-200 dark:fill-gray-50"
                  width={12}
                  height={7}
                  aria-hidden="true"
                />
